...
(function () {
  ...
  const text = {
    en: { meet: "Meet", female: "Female", male: "Male", small: "Small", medium: "Medium", large: "Large", atApasa: "At APASA", cross: "cross", senior: "Senior", longstay: "Long-term", newArrival: "New arrival", search: "Search by name", allSexes: "All sexes", allSizes: "All sizes", allAges: "All ages", allSpecial: "All special dogs", puppy: "Puppy", young: "Young", adult: "Adult", newDogs: "New arrivals", sortName: "Name A–Z", sortLongest: "Longest waiting", sortNewest: "Newest arrivals", sortYoungest: "Youngest", sortOldest: "Oldest", clear: "Clear filters", dogs: "dogs", oneDog: "dog", noResults: "No dogs match these filters." },
    es: { meet: "Conoce a", female: "Hembra", male: "Macho", small: "Pequeño", medium: "Mediano", large: "Grande", atApasa: "En APASA", cross: "cruce", senior: "Senior", longstay: "Larga estancia", newArrival: "Recién llegado", search: "Buscar por nombre", allSexes: "Todos los sexos", allSizes: "Todos los tamaños", allAges: "Todas las edades", allSpecial: "Todos los perros especiales", puppy: "Cachorro", young: "Joven", adult: "Adulto", newDogs: "Recién llegados", sortName: "Nombre A–Z", sortLongest: "Más tiempo esperando", sortNewest: "Llegadas recientes", sortYoungest: "Más jóvenes", sortOldest: "Mayores", clear: "Borrar filtros", dogs: "perros", oneDog: "perro", noResults: "Ningún perro coincide con estos filtros." },
    de: { meet: "Triff", female: "Hündin", male: "Rüde", small: "Klein", medium: "Mittel", large: "Groß", atApasa: "Bei APASA", cross: "Mischling", senior: "Senior", longstay: "Langzeitgast", newArrival: "Neu angekommen", search: "Nach Namen suchen", allSexes: "Alle Geschlechter", allSizes: "Alle Größen", allAges: "Alle Altersgruppen", allSpecial: "Alle besonderen Hunde", puppy: "Welpe", young: "Junghund", adult: "Erwachsen", newDogs: "Neu angekommen", sortName: "Name A–Z", sortLongest: "Längste Wartezeit", sortNewest: "Neueste Ankünfte", sortYoungest: "Jüngste", sortOldest: "Älteste", clear: "Filter löschen", dogs: "Hunde", oneDog: "Hund", noResults: "Keine Hunde entsprechen diesen Filtern." }
  }[lang];
